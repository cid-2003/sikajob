function passwordStrengthMeter(a) {
    ...
    function d(a) {
        1 === a ? (g.className = "password-strength-meter-score psms-25",
        k && (k.textContent = l[1] || "Too simple"),
        f.dispatchEvent(new Event("onScore1",{
            bubbles: !0
        }))) : 2 === a ? (g.className = "password-strength-meter-score psms-50",
        k && (k.textContent = l[2] || "Simple"),
        f.dispatchEvent(new Event("onScore2",{
            bubbles: !0
        }))) : 3 === a ? (g.className = "password-strength-meter-score psms-75",
        k && (k.textContent = l[3] || "That's OK"),
        f.dispatchEvent(new Event("onScore3",{
            bubbles: !0
        }))) : 4 === a ? (g.className = "password-strength-meter-score psms-100",
        k && (k.textContent = l[4] || "Great password!"),
        f.dispatchEvent(new Event("onScore4",{
            bubbles: !0
        }))) : (g.className = "password-strength-meter-score",
        k && (k.textContent = l[0] || "No data"),
        f.dispatchEvent(new Event("onScore0",{
            bubbles: !0
        })))
    }
    ...
    return k && (k.textContent = l[0] || "No data"),
    {
        containerElement: f,
        getScore: c
    }
