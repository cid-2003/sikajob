                        ...
                        @if (Auth::check() && Auth::user()->role === 'Candidat')
                            <li>
                                <a class="dropdown-item"
                                    ...
                                    <i class="fa fa-paper-plane fa-fw pe-2"></i>Postuler à cette
                                    offre
                                </a>
                            </li>
            ...
            <div class="modal-content">
                <form method="POST" action="">
                    ...
                    <div class="modal-body">
                        <label for="reason" class="form-label">Raison du signalement
                            :</label>
                ...
                <ul class="nav nav-stack">
                    <li class="nav-item">
                        <button class="nav-link like-button {{ $publication->liked }}"
                            ...
                            <i class="fa fa-thumbs-up -fill pe-1"
                                @if ($publication->liked) style="color: #007bff" @endif></i>
